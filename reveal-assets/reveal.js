...
!(function (e, t) {
      ...
      (e.style.display = this.Reveal.getConfig().display),
        ...
        t(e, "video, audio").forEach((e) => {
          ...
          t(e, "source[data-src]").forEach((e) => {
            ...
            h && "VIDEO" === e.tagName && e.setAttribute("playsinline", ""),
            i > 0 && e.load();
        });
        ...
        if (!1 === s.hasAttribute("data-loaded")) {
          ...
          if (n)
            ...
            o && e.setAttribute("loop", ""),
              l && (e.muted = !0),
              h && ((e.muted = !0), e.setAttribute("playsinline", "")),
              r.split(",").forEach((t) => {
  ...
  class k {
    ...
    run(e, t) {
      ...
      if (
        ...
        let r = this.getAutoAnimatableElements(e, t).map((e) =>
          this.autoAnimateElements(e.from, e.to, e.options || {}, i, R++),
        );
        if (
    ...
    autoAnimateElements(e, t, i, s, a) {
      ...
      if (
        ...
        (e.className.match(b) || [""])[0] ===
          (t.className.match(b) || [""])[0] &&
  ...
  class C {
    ...
    async activate() {
      ...
      await new Promise(requestAnimationFrame),
        o("@page{size:" + n + "px " + r + "px; margin: 0px;}"),
        o(
      ...
      i.forEach(function (i, a) {
        if (!1 === i.classList.contains("stack")) {
          ...
          (v = Math.min(v, e.pdfMaxPagesPerSlide)),
            ((1 === v && e.center) || i.classList.contains("center")) &&
              (c = Math.max((r - p) / 2, 0));
          const f = document.createElement("div");
          if (
            (g.push(f),
            (f.className = "pdf-page"),
            (f.style.height = (r + e.pdfPageHeightOffset) * v + "px"),
    ...
    activate() {
      if (
        ...
        (this.active = !0),
          ...
          t(this.Reveal.getRevealElement(), v).forEach((e) => {
  ...
  class T {
    ...
    onDocumentKeyDown(e) {
      ...
      let a =
        ...
        o =
          !(
            (-1 !== [32, 37, 38, 39, 40, 78, 80, 191].indexOf(e.keyCode) &&
              e.shiftKey) ||
            e.altKey
          ) &&
  ...
  function K(n, o) {
    ...
    let c,
      ...
      R = {},
      H = !1,
      z = { hasNavigatedHorizontally: !1, hasNavigatedVertically: !1 },
      q = [],
      K = 1,
      $ = { layout: "", overview: "" },
      X = {},
    ...
    function fe() {
      (H = !0),
        ...
        R.postMessage && window.addEventListener("message", St, !1),
        setInterval(() => {
          ...
          (e || t) &&
            ...
            e
              ? "complete" === document.readyState
                ? ne.activate()
                : window.addEventListener("load", () => ne.activate())
              : ae.activate());
        })(),
        de.readURL(),
        setTimeout(() => {
          X.slides.classList.remove("no-transition"),
            ...
            Le({
              type: "ready",
              data: { indexh: c, indexv: u, currentSlide: b },
            });
        }, 1);
    }
    function ye(e) {
    ...
    function we(t) {
      ...
      X.wrapper.classList.remove(s.transition),
        X.wrapper.classList.add(R.transition),
        X.wrapper.setAttribute("data-transition-speed", R.transitionSpeed),
        ...
        X.viewport.style.setProperty(
          "--slide-width",
          "string" == typeof R.width ? R.width : R.width + "px",
        ),
        X.viewport.style.setProperty(
          "--slide-height",
          "string" == typeof R.height ? R.height : R.height + "px",
        ),
        R.shuffle && Je(),
        i(X.wrapper, "embedded", R.embedded),
        i(X.wrapper, "rtl", R.rtl),
        i(X.wrapper, "center", R.center),
        !1 === R.pause && je(),
        R.previewLinks
        ...
        a > 1 &&
          ...
          S.on("click", Pt),
          (Q = !1)),
        "default" !== R.navigationMode
          ? X.wrapper.setAttribute("data-navigation-mode", R.navigationMode)
    ...
    function Ee() {
      window.addEventListener("resize", kt, !1),
        ...
        R.keyboard && le.bind(),
        R.progress && he.bind(),
        R.respondToHashChanges && de.bind(),
        ce.bind(),
        pe.bind(),
        ...
        R.focusBodyOnPageVisibilityChange &&
      ...
      if (X.wrapper && !ne.isActive()) {
        ...
        if (!R.disableLayout) {
          ...
          He(R.width, R.height),
            ...
            (K = Math.max(K, R.minScale)),
            (K = Math.min(K, R.maxScale)),
            1 === K || ae.isActive()
              ? ((X.slides.style.zoom = ""),
                (X.slides.style.left = ""),
                (X.slides.style.top = ""),
              ...
              : ((X.slides.style.zoom = ""),
                ...
                ke({ layout: "translate(-50%, -50%) scale(" + K + ")" }));
          const a = Array.from(X.wrapper.querySelectorAll(v));
          for (let e = 0, t = a.length; e < t; e++) {
            const t = a[e];
            "none" !== t.style.display &&
              (R.center || t.classList.contains("center")
          ...
          s !== K &&
            Le({ type: "resize", data: { oldScale: s, scale: K, size: i } });
        }
        !(function () {
          if (
            X.wrapper &&
            !R.disableLayout &&
            !ne.isActive() &&
            "number" == typeof R.scrollActivationWidth &&
            "scroll" !== R.view
          ) {
            const e = De();
            e.presentationWidth > 0 &&
            e.presentationWidth <= R.scrollActivationWidth
              ? ae.isActive() || (se.create(), ae.activate())
              : ae.isActive() && ae.deactivate();
          }
        })(),
          X.viewport.style.setProperty("--slide-scale", K),
    ...
    function De(e, t) {
      ...
      return (
        (a.presentationWidth -= a.presentationWidth * R.margin),
        (a.presentationHeight -= a.presentationHeight * R.margin),
    ...
    function Ue() {
      return (
        ...
        (!qe(b) || !b.parentNode.nextElementSibling)
      );
    }
    function Ve() {
      if (R.pause) {
    ...
    function Xe(e, i, s, a) {
      ...
      d &&
        ...
        ((Y = "running"),
        (v = Ye(g, b, o, l)),
        v && X.slides.classList.add("disable-slide-transitions")),
        et(),
        Be(),
        oe.isActive() && oe.update(),
        void 0 !== s && re.goto(s),
      ...
      d && Ce(a),
        (!d && g) || (Z.stopEmbeddedContent(g), Z.startEmbeddedContent(b)),
        requestAnimationFrame(() => {
          ye(be(b));
        }),
        he.update(),
    ...
    function Ye(e, t, i, s) {
      return (
        ...
        e.getAttribute("data-auto-animate-id") ===
          t.getAttribute("data-auto-animate-id") &&
        !(c > i || u > s ? t : e).hasAttribute("data-auto-animate-restart")
      );
    }
    function _e() {
      Se(),
        ...
        se.create(),
        de.writeURL(),
        !0 === R.sortFragmentsOnSync && re.sortAll(),
        ce.update(),
        he.update(),
        et(),
        me.update(),
        ...
        !1 === R.autoPlayMedia
          ? Z.stopEmbeddedContent(b, { unloadIframes: !1 })
          : Z.startEmbeddedContent(b),
    ...
    function Ge(e, i) {
      let s = t(X.wrapper, e),
        ...
        o = !1;
      if (a) {
        R.loop && (i >= a && (r = !0), (i %= a) < 0 && ((i = a + i), (o = !0))),
        ...
        for (let e = 0; e < a; e++) {
          ...
          t.classList.remove("past"),
            ...
            n
              ? t.classList.add("present")
              : e < i
              ? (t.classList.add(a ? "future" : "past"), R.fragments && Qe(t))
              : e > i
              ? (t.classList.add(a ? "past" : "future"), R.fragments && Ze(t))
              : e === i && R.fragments && (r ? Ze(t) : o && Qe(t));
        }
        let e = s[i],
    ...
    function et() {
      ...
      if (a && void 0 !== c) {
        ...
        h && (n = oe.isActive() ? 6 : R.mobileViewDistance),
        ...
        for (let r = 0; r < a; r++) {
          ...
          if (
            ...
            for (let s = 0; s < d; s++) {
              let a = l[s];
              (i = r === (c || 0) ? Math.abs((u || 0) - s) : Math.abs(s - t)),
        ...
        if (b.querySelectorAll(".fragment").length > 0) {
          ...
          i =
            e && e.hasAttribute("data-fragment-index")
              ...
              : b.querySelectorAll(".fragment.visible").length - 1;
        }
      }
      return { h: s, v: a, f: i };
    }
    function at() {
      return t(
        X.wrapper,
        v + ':not(.stack):not([data-visibility="uncounted"])',
      );
    }
    function nt() {
    ...
    function ut() {
      if ((gt(), b && !1 !== R.autoSlide)) {
        ...
        i
          ...
          ? (_ = parseInt(s, 10))
          : ((_ = R.autoSlide),
            0 === b.querySelectorAll(".fragment").length &&
              t(b, "video, audio").forEach((e) => {
          ...
          !_ ||
            ...
            $e() ||
            oe.isActive() ||
            (Ue() && !re.availableRoutes().next && !0 !== R.loop) ||
            ((J = setTimeout(() => {
              "function" == typeof R.autoSlideMethod
                ? R.autoSlideMethod()
                : Et(),
                ut();
            }, _)),
    ...
    function mt({ skipFragments: e = !1 } = {}) {
      if (((z.hasNavigatedHorizontally = !0), ae.isActive())) return ae.prev();
      R.rtl
        ? (oe.isActive() || e || !1 === re.next()) &&
          tt().left &&
          Xe(c + 1, "grid" === R.navigationMode ? u : void 0)
        : (oe.isActive() || e || !1 === re.prev()) &&
          tt().left &&
          Xe(c - 1, "grid" === R.navigationMode ? u : void 0);
    }
    function ft({ skipFragments: e = !1 } = {}) {
      if (((z.hasNavigatedHorizontally = !0), ae.isActive())) return ae.next();
      R.rtl
        ? (oe.isActive() || e || !1 === re.prev()) &&
          tt().right &&
          Xe(c - 1, "grid" === R.navigationMode ? u : void 0)
    ...
    function bt({ skipFragments: e = !1 } = {}) {
      if (((z.hasNavigatedVertically = !0), ae.isActive())) return ae.next();
      (oe.isActive() || e || !1 === re.next()) && tt().down && Xe(c, u + 1);
    }
    function wt({ skipFragments: e = !1 } = {}) {
      ...
      if (e || !1 === re.prev())
        if (tt().up) yt({ skipFragments: e });
          ...
          if (
            ((i = R.rtl
              ? t(X.wrapper, m + ".future").pop()
              : t(X.wrapper, m + ".past").pop()),
    ...
    function Et({ skipFragments: e = !1 } = {}) {
      if (
        ((z.hasNavigatedHorizontally = !0),
        (z.hasNavigatedVertically = !0),
        ae.isActive())
      )
        return ae.next();
      if (e || !1 === re.next()) {
        let t = tt();
        t.down && t.right && R.loop && Oe() && (t.down = !1),
          t.down
            ? bt({ skipFragments: e })
            : R.rtl
            ? mt({ skipFragments: e })
    ...
    function At(e) {
      "running" === Y &&
        ...
        Le({
          ...
          data: { indexh: c, indexv: u, previousSlide: g, currentSlide: b },
        }));
    }
    function Rt(e) {
    ...
    const Tt = {
      ...
      initialize: function (e) {
        ...
        if (
          ((X.wrapper = n), (X.slides = n.querySelector(".slides")), !X.slides)
        )
          throw 'Unable to find slides container (<div class="slides">).';
        return (
          (R = { ...V, ...R, ...o, ...e, ...l() }),
          /print-pdf/gi.test(window.location.search) && (R.view = "print"),
          (function () {
            !0 === R.embedded
          ...
          ge.load(R.plugins, R.dependencies).then(fe),
      ...
      destroy: function () {
        Se(),
          ...
          Array.from(X.wrapper.querySelectorAll(v)).forEach((e) => {
      ...
      getProgress: function () {
        ...
        if (b) {
          ...
          if (e.length > 0) {
            let i = 0.9;
            t +=
              (b.querySelectorAll(".fragment.visible").length / e.length) * i;
          }
        }
      ...
      setCurrentScrollPage: function (e, t, i) {
        ...
        (g = b),
          (b = e),
          b && g && R.autoAnimate && Ye(g, b, s, u) && ie.run(g, b),
          a &&
            (g &&
              (Z.stopEmbeddedContent(g),
              Z.stopEmbeddedContent(g.slideBackgroundElement)),
            Z.startEmbeddedContent(b),
            Z.startEmbeddedContent(b.slideBackgroundElement)),
          requestAnimationFrame(() => {
            ye(be(b));
          }),
          Ce();
  ...
  return (
    ($.initialize = (e) => (
      Object.assign($, new K(document.querySelector(".reveal"), e)),
      X.map((e) => e($)),
      $.initialize()
    )),
    [
