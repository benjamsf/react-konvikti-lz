...
export function OrgView() {
  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      description: t("org.history1.description", "Ylioppilaskoti Konviktin kannatusyhdistys ry perustettiin vuonna 1917."),
    },
    {
      year: "1920",
      title: t("org.history2.title", "Ensimmäinen Konvikti"),
      description: t("org.history2.description", "Vuonna 1920 perustettiin ylioppilaskoti, konvikti."),
    },
    {
      year: "1930-l.",
      title: t("org.history3.title", "Muutto Meritullinkadulle"),
      description: t("org.history3.description", "Nykyiseen Isoon-Konviktiin koti siirtyi 30-luvulla."),
    },
    {
      year: "1960-l.",
      title: t("org.history4.title", "Pikku-Konvikti"),
      description: t("org.history4.description", "Emil ja Mimmi Juurinen testamenttilahjoitti kaksi huoneistoa."),
    },
    {
      year: "1999",
      title: t("org.history5.title", "Jukola"),
      description: t("org.history5.description", "Meritullinkatu 22:n rapussa sijainnut Raittiuskoti siirtyi Konviktin käyttöön."),
    },
    {
      year: "2024",
      title: t("org.history6.title", "Uudelleenjärjestely"),
      description: t("org.history6.description", "Kasvaneista kustannuksista johtuen yhdistys joutui luopumaan Jukolasta ja Mirkkulasta."),
    },
    {
      year: "2026",
      title: t("org.history7.title", "Uusi aika"),
      description: t("org.history7.description", "109-vuotias Konvikti tähyää tulevaisuuteen."),
    },
  ];
  ...
  return (
    <Layout
      showFooter={true}
      heroImage={heroImage}
      heroTitle={t("org.hero.title", "Claustrum Theologicum - Ylioppilaskoti Konviktin kannatusyhdistys r.y.")}
      heroText={t("org.hero.subtitle", "Teologian opiskelijoiden koti vuodesta 1917")}
    >
      {/* Core Staff - from Sanity */}
      <StaffGrid
        title={t("org.staffSection.title", "Henkilökunta")}
        subtitle={t("org.staffSection.subtitle", "Tutustu henkilöstöömme, joka pitää Konviktin toiminnassa")}
      ...
      <StaffList
        ...
        subtitle={t("org.boardSection.subtitle", "Yhdistyksen johtokunta ohjaa toimintaamme")}
      ...
      <JoinOrgSection
        ...
        description={t("org.join.description", "Etsimme tehtävästämme kiinnostuneita ihmisiä mukaan toimintaamme. Hallituspaikat, vapaaehtoistyö ja muut mahdollisuudet odottavat sinua.")}
      ...
      <JoinOrgSection
        ...
        description={t("org.joinFinal.description", "Yhdistyksen tukijäsenenä voit tukea Konviktin arvojen ja tavoitteiden toteutumista pienellä vuosimaksulla ja haluamallasi tavalla. Olit sitten Konviktin alumni tai vain kiinnostunut toiminnastamme – ovet ovat auki.")}
