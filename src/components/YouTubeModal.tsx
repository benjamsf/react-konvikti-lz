    ...
    <Dialog.Root open={open} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="bg-backgroundLight rounded-lg relative max-w-full w-full max-h-full h-auto md:max-w-[80%] md:max-h-[80%]">
            <button
              onClick={(e) => {
                e.stopPropagation(); // Prevent any navigation or event bubbling
